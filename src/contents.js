...
const createSubtitleElement = () => {
  ...
  subtitleElement.setAttribute('style', 'position: fixed; bottom: 50px; left: 50%; transform: translateX(-50%); z-index: 10000; display:flex; justify-content: center; width: 80vw; max-height: 50px; pointer-events:');
